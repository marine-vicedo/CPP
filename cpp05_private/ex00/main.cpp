...
/*   Updated: 2023/11/02 11:35:56 by mvicedo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat* createBureaucrat(std::string name, int grade)
{
	...
	{
		std::cerr << e.what() << '\n';
		//fonction virtuelle pure définie dans la classe de base std::exception du C++.
		//Elle est utilisée pour récupérer une chaîne de caractères (généralement un message d'erreur) associée à l'exception. 
		return (NULL);
	}
}
