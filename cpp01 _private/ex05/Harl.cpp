...
/*   Updated: 2023/09/26 16:01:38 by mvicedo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::complain(std::string level)
{
	...
	//créer un tableau de pointeurs de fonction membres (ptr_complain) dans la classe Harl.
	//Chaque élément du tableau pointe vers une des fonctions membres privées de Harl qui correspond à un niveau de plainte spécifique (debug, info, warning, error).
	std::string levels[4] = {"DEBUG", "INFO", "WARNING", "ERROR"};
	//crée un tableau de chaînes de caractères levels contenant les niveaux de plainte valides 
